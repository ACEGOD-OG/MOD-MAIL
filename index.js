...
// client = your bot like your bot is a then you can make client name to A
...
client.user.setActivity("",{type: "DM ME TO CONTACT WITH STAFF"})
})//BOT' STATUS 
//CLIENT = YOUR BOT,USER =  IT'S NOW LIVE ON DISCORD AND setActivity = it will save your bot status
...
client.on("message", async message => {
  ...
  if(message.guild) {
      if(command == "setup") {
        ...
        .setDescription("This bot is made by 𝓚𝓾𝓭𝓪#4910, You can remove credits :D")
